...
class OwnerEnergyConsumptionContainer extends StatefulWidget {
  final bool isDark;
  final VoidCallback? onExpand;

  const OwnerEnergyConsumptionContainer({
    super.key,
  ...
  @override
  State<OwnerEnergyConsumptionContainer> createState() => _OwnerEnergyConsumptionContainerState();
}

class _OwnerEnergyConsumptionContainerState extends State<OwnerEnergyConsumptionContainer> 
