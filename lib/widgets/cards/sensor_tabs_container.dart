          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                IconButton(
                icon: Icon(Icons.auto_awesome_mosaic_sharp, size: 22,color: widget.isDark ? Colors.white : Colors.black,),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(Icons.settings, size: 22,color: widget.isDark ? Colors.white : Colors.black,),
