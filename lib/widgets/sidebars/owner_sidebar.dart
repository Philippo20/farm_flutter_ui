...
class OwnerSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final navItems = [
      _NavItem(icon: Icons.dashboard_outlined, label: 'Home', activeIcon: Icons.dashboard, route: '/owner_dashboard'),
      _NavItem(icon: Icons.agriculture_outlined, label: 'Farm', activeIcon: Icons.agriculture, route: '/owner_farm'),
      _NavItem(icon: Icons.settings_outlined, label: 'Settings', activeIcon: Icons.settings, route: '/owner_settings'),
    ];
