...
/// Modern packaging supervisor header with greeting, weather, notifications, and theme toggle
class PackagingSupervisorHeader extends ConsumerWidget {
  ...
  const PackagingSupervisorHeader({
    super.key,
