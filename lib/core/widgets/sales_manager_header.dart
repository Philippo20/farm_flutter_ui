...
/// Modern sales manager header with greeting, weather, notifications, and theme toggle
class SalesManagerHeader extends ConsumerWidget {
        ...
        return PopupMenuButton<String>(
          ...
          onSelected: (value) async {
            if (value == 'logout') {
              ...
              Navigator.of(context).pushNamed('/sales-settings');
