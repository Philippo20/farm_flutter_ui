...
class FarmsDashboardScreen extends StatefulWidget {
  const FarmsDashboardScreen({super.key});

  @override
  State<FarmsDashboardScreen> createState() => _farmsDashboardScreenState();
}

class _farmsDashboardScreenState extends State<FarmsDashboardScreen> {
  int selectedIndex = 1;
  bool isDark = false;
