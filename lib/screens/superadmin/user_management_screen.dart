...
class _UserManagementScreenState extends ConsumerState<UserManagementScreen> {
  ...
  Widget _buildUserTable(List<Map<String, dynamic>> filteredUsers, bool isDark) {
    return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: stat['color'] as Color),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                    Text(
                      stat['title'] as String,
                      style: TextStyle(fontSize: 11, color: (stat['color'] as Color).withOpacity(0.8)),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDropdownField(
                          ...
                          items: ['Administration', 'Management', 'Farm Operations', 'Field Work'],
                              ...
                              SnackBar(
                                content: Row(
                                  children: [
                                    ...
                                    Text('${nameController.text.isEmpty ? "User" : nameController.text} added successfully!'),
                                  ],
                                ),
                              ...
                              SnackBar(
                                content: Row(
                                  children: [
                                    const Icon(Icons.check_circle, color: Colors.white),
                                    const SizedBox(width: 8),
                                    Text('${nameController.text} updated successfully!'),
                                  ],
                                ),
                                backgroundColor: AppColors.success,
                                behavior: SnackBarBehavior.floating,
  ...
  void _showDeleteConfirmDialog(BuildContext context, Map<String, dynamic> user, bool isDark) {
    showDialog(
      context: context,
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: items.map((item) => DropdownMenuItem(
            ...
            child: Row(
              children: [
                Icon(icon, color: isDark ? Colors.white54 : AppColors.textSecondary, size: 20),
                const SizedBox(width: AppSpacing.md),
                Text(item),
              ],
            ),
