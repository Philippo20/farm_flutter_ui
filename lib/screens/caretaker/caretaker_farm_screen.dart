...
class CaretakerFarmScreen extends StatefulWidget {
  const CaretakerFarmScreen({super.key});

  @override
  State<CaretakerFarmScreen> createState() => _caretakerFarmsScreenState();
}

class _caretakerFarmsScreenState extends State<CaretakerFarmScreen> {
  int selectedIndex = 1;
  bool isDark = false;
